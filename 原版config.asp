...
Const cookies_name="oblog312" 	'cookies名,一般无须修改
Const cookies_domain="" 	'cookeies域名根,一般留空
Const cache_name_user="oblog" 	'系统缓存名前缀，一般无须修改
...
const logfilepath=1	'文章文件路径，0为根目录，1为"/archives/年份/"目录
...
const P_TAGS_DESC="文章标签"	 'TAG DESC
