...
case "state"
	...
	Response.Write "<script language=javascript>parent.location.href=""administrator.asp"";</script>"
case else
	call main()
end select
...
<frameset rows="*" cols="251,*" framespacing="0" frameborder="0" border="false" id="frame" scrolling="yes">
  <frame name="left" scrolling="auto" marginwidth="0" marginheight="0" src="administrator.asp?action=left">
  <frameset framespacing="0" border="false" rows="35,*" frameborder="0" scrolling="yes">
    <frame name="top" scrolling="no" src="administrator.asp?action=top">
    <frame name="main" scrolling="auto" src="administrator.asp?action=main">
  </frameset>
</frameset>
<noframes>
...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
          <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background=images/admin/bg.gif id=menuTitle0> 
            <span><a href="administrator.asp?action=main" target=main><b>管理首页</b></a> 
...
<td height=25 colspan=2 class="topbg"><strong>系统启动与关闭</strong></th></tr> 
   ...
   <form name="systemcontrol" method="post" action="administrator.asp?action=state">
	  <tr> 
