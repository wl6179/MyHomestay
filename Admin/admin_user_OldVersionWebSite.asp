...
strFileName="admin_user_OldVersionWebSite.asp?UserSearch=" & UserSearch
if strField<>"" then
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" Class="border">
  <tr class="topbg"> 
    <td height="22" colspan=2 align=center><strong><font color="#Fcc000">旧 版 网 站</font> 用 户 管 理</strong></td>
  </tr>
  <form name="form1" action="admin_user_OldVersionWebSite.asp" method="get">
    <tr class="tdbg"> 
      ...
      <td width="687" height="30"><select size=1 name="UserSearch" onChange="javascript:submit()">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<a href="admin_user_OldVersionWebSite.asp">老版网站 中国家庭用户管理首页</a>&nbsp;|&nbsp;<a href="/RegisterHome.asp" target="_blank">添加新用户</a></td>
    </tr>
  </form>
  <form name="form2" method="post" action="admin_user_OldVersionWebSite.asp">
  <tr class="tdbg">
...
sub main()
	dim strGuide
	strGuide="<table width='100%'><tr><td align='left'>您现在的位置：<a href='admin_user_OldVersionWebSite.asp'>注册老版网站 中国家庭用户管理</a>&nbsp;&gt;&gt;&nbsp;"
	select case UserSearch
		case 0
			sql="select top 500 * from tbUser_Info   order by UserID desc"
			...
			if Keyword="" then
				...
				case "blogname"
					if is_sqldata=1 then
						sql="select * from tbUser_Info where User_RName like '%" & Keyword & "%' order by userID  desc"
						strGuide=strGuide & "真实姓名中含有“ <font color=red>" & Keyword & "</font> ”的用户"
					else
						sql="select * from tbUser_Info where User_RName= '" & Keyword & "' order by userID  desc"
...
<table width='98%' border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
  <form name="myform" method="Post" action="admin_user_OldVersionWebSite.asp" onSubmit="return confirm('确定要执行选定的操作吗？');">
     <td>
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
          <tr class="title"> 
            ...
            <td width="65" height="22" align="center"><font color="#FFFFFF">真实姓名</font></td>
            <td width="75" height="22" align="center"><font color="#FFFFFF">年龄</font></td>
            <td width="30" align="center"><font color="#FFFFFF">性别</font></td>
			<td width="75" height="22" align="center"><font color="#FFFFFF">所在地区(省/市)</font></td>
            
			<td width="150" align="center"><font color="#cccccc">住址</font></td>
            <td width="150" height="22" align="center"><font color="#FFFFFF">Email</font></td>
            <td width="100" height="22" align="center"><font color="#FFFFFF"> 
              联系电话</font></td>
          </tr>
          <%do while not rs.EOF %>
          <tr class="tdbg" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'"> 
			...
			response.write """  title='[家庭人口:"&rs("User_populace")&"]..[外教性别:"&rs("User_Wsex")&"]..[是否会说中文:"&rs("User_Chinese")&"次]...[房间结构:"&rs("User_house")&"]..[是否能上网:"&rs("User_net")&"]..[是否有宠物:"&rs("User_pet")&"]..[如何知道我们:"&rs("User_we")&"]'>" & rs("User_RName") & "</a>"
			%> </td>
            <td width="75" align="center"> <%=rs("User_age")%> </td>
            
			<td width="30" align="center"> <%=rs("User_Sex")%></td>
	...
	%> </td>
			...
			<td width="150" align="center"> <%=rs("User_Add")%></td>
			
            <td width="150" align="center">【<u><%=rs("User_Date")%></u>】<%

	  	response.write rs("User_Email")
	  ...
	  %></td>
			...
			response.write rs("User_MPhone") &"，"& rs("User_Phone")
    ...
    <td width="200" height="30"><input name="chkAll" type="checkbox" id="chkAll" onclick=CheckAll(this.form) value="checkbox">
            ...
            <td> <strong>操作：</strong> 
              ...
              <select name="User_Level" id="User_Level" disabled>
                <option value="6">老版网站 中国家庭用户</option>
...
%>
<FORM name="Form1" action="admin_user_OldVersionWebSite.asp" method="post">
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
    <TR class='title'> 
      <TD height=22 colSpan=2 align="center"><b><font color="#FFFFFF">修改注册老版网站 中国家庭用户信息</font></b></TD>
    </TR>
    <TR class="tdbg" > 
      <TD width="40%">用户名：</TD>
    ...
    <TR style="display:none;" class="tdbg" > 
      ...
      <TD width="60%"><select name="User_Level" id="User_Level">
          <option value="6" <%if clng(rsUser("user_level"))=6 then response.Write("selected")%>>老版网站 中国家庭用户</option>
...
sub UpdateUser()
%>
<FORM name="Form1" action="admin_user_OldVersionWebSite.asp?action=DoUpdate" method="post">
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
...
<FORM name="Form1" action="admin_user_OldVersionWebSite.asp?action=DoUpdatelog" method="post">
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
    <tr align="center" class="title"> 
...
%>
<FORM name="Form1" action="admin_user_OldVersionWebSite.asp?action=gouser2" method="post" target="_blank">
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
    <tr align="center" class="title"> 
...
sub DelUser()
	...
	response.redirect "admin_user_OldVersionWebSite.asp"
end sub
...
sub MoveUser()
	...
	if instr(UserID,",")>0 then
		...
		if User_Level=6 then
			msg="&nbsp;&nbsp;&nbsp;&nbsp;已经成功将选定用户设为“<font color=blue>老版网站 中国家庭用户</font>”！"
...
sub ShowInfo()
	...
	Dim strGuide
	strGuide=strGuide&"<table width='100%'><tr><td align='left'>您现在的位置：<a href='admin_user_OldVersionWebSite.asp'>注册老版网站 中国家庭用户管理</a>&nbsp;&gt;&gt;&nbsp;" & "老版网站 中国家庭<font color=red>"& rsuser("blogname") &"</font>的详细信息</td></tr></table>"
...
%>
  ...
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="border">
    <TR class='title'> 
      <TD height=22 colSpan=2 align="center"><b><font color="#FFFFFF">(MH00<%=rsuser("userID")%>)老版网站 中国家庭用户详细信息</font></b>&nbsp;&nbsp;</TD>
    </TR>
    <TR class="tdbg" > 
...
Sub change_isValidate()'设置老版网站 中国家庭是否通过我站点审核...通过便可以在站点显示，成为公开家庭用户.
	dim sql,rs,id
	Dim isValidate
	...
	oblog.showok "保存更新","admin_user_OldVersionWebSite.asp"
	
End Sub


Sub change_isStop()'设置老版网站 中国家庭是否通过我站点审核...通过便可以在站点显示，成为公开家庭用户.
	dim sql,rs,id
	Dim isStop
