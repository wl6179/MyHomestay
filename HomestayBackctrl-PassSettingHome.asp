...
<div id="list">
	...
	<form name="oblogform" method="post" action="HomestayBackctrl-PassSettingHome.asp" onSubmit="submits(); ">
...
<div id="list">	
	...
	<hr>
	<form name="form1" method="post" action="HomestayBackctrl-PassSettingHome.asp?action=addblogpassword" onSubmit='return Verify()'>
	密码：
	<input type="password" name="password" /> 
	<input type="submit" name="Submit" value="全站加密" />        
	</form>
	<br />
	<form name="form2" method="post" action="HomestayBackctrl-PassSettingHome.asp?action=unblogpassword" />
...
<div id="list">
	<form name="oblogform" action="HomestayBackctrl-PassSettingHome.asp" method="post">
...
sub savesitesetup()
	...
	if oblog.errstr<>"" then oblog.showusererrHome:exit sub
...
<div id="list">
	...
	<hr /></ul>
	<form  method="post" action="HomestayBackctrl-PassSettingHome.asp?action=saveblogstar">
	<ul>
	<li class="t1">用户名字：</li>
...
<div id="list">
    ...
    <ul> 
      ...
      <li class="t2"><input onFocus="this.select(); " name=question  type="text" size="30" maxlength="20" value="<%=oblog.filt_html(rs(0))%>"><font color="#FF0000"> *</font>&nbsp;&nbsp;&nbsp;(如需修改，请填写)</li>
    </ul>
	 <ul> 
