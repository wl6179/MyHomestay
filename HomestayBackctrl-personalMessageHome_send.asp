...
<div id="list">
<form action="HomestayBackctrl-personalMessageHome_send.asp?action=save" method="post" name="oblogform">
...
<ul>
	...
	<% Else %>
		<input type="button" onClick="window.location='HomestayBackctrl-personalMessageHome_send.asp?action=send&incept=<%=rs("sender")%>&topic=<%="回复:"&oblog.filt_html(rs("topic"))%>'" value=" 回复 ">
	<% End If %>	
