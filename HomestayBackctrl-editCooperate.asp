...
<iframe id=d_file frameborder=0 src="HomestayBackctrl-uploadCooperate.asp?tMode=<%=t%>&re=" width="100%" height="40" scrolling=no></iframe><%end if%>
<div id="oblog_edit">
	<ul id="ExtToolbar0">
	<li >
	<%If t<>"1" Then%>
...
<ul class="list_edit">
<iframe id=d_file frameborder=0 src="HomestayBackctrl-uploadCooperate.asp?ubb=1" width="100%" height="40" scrolling=no></iframe>
