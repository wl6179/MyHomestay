...
<!--#include file="inc/class_blog.asp"-->
 ...
 <div id="head">
			...
			<div id="mainContentList">
				...
				<div id="main-main-round">
					...
					<div id="main-TextArea01">
						...
						<center><h2>MyHomestay 企业消息管理</h2></center>
	...
	<div class="submenu_content" style="display:block;">
		  &nbsp;<img src="/images/mailmanage.gif" /><a href="HomestayBackctrl-personalMessageCooperate.asp" title="接收住家网写给我的所有消息">收件箱</a>
		| &nbsp;<img src="/images/mailsend.gif" /><a href="HomestayBackctrl-personalMessageCooperate.asp?usersearch=1" title="我写给住家网的所有消息保存">发件箱</a>
		| &nbsp;<img src="/images/mail_write.gif" /><a href="javascript:openScript('HomestayBackctrl-personalMessageCooperate_send.asp?action=send',450,400)" title="写信与住家网进行沟通">我要写信</a>
	</div>
...
strFileName="HomestayBackctrl-personalMessageCooperate.asp?usersearch=" & usersearch
...
%>
	...
	<form name="myform" method="Post" action="HomestayBackctrl-personalMessageCooperate.asp?usersearch=<%=usersearch%>" onSubmit="return confirm('确定要执行选定的操作吗？');">
<table>
	<tr class="tr01">
...
<style>
	...
	<%end if%>
		...
		<td class="tr02-3"><a href="javascript:openScript('HomestayBackctrl-personalMessageCooperate_send.asp?action=read&id=<%=rs("id")%>',650,468)"><%=oblog.filt_html(rs("topic"))%></a></td>
		...
		<td class="tr02-7">
	<%response.write "<a href='HomestayBackctrl-personalMessageCooperate.asp?action=del&id=" & rs("id") &"&usersearch="&usersearch&"' onClick='return confirm(""确定要删除吗？"");'>删除</a>"%>
		</td>
	</tr>
<%
	i=i+1
