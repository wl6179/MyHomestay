...
<%=oblog.htm2js_div(" ", "calendar")%><br /><br /><br />

<%
 Dim kkk_blogdir
 	kkk_blogdir=server.MapPath("/")
	response.Write("kkk_blogdir的MapPath地址："&kkk_blogdir)
 Call oblog.BuildFile(kkk_blogdir & "/user1/000000.htmll", " ") 
 %>
