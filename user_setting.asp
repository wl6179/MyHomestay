...
<div id="list">
	...
	<form name="oblogform" method="post" action="user_setting.asp" onSubmit="submits(); ">
...
<div id="list">	
	...
	<hr>
	<form name="form1" method="post" action="user_setting.asp?action=addblogpassword" onSubmit='return Verify()'>
	密码：
	<input type="password" name="password" /> 
	<input type="submit" name="Submit" value="全站加密" />        
	</form>
	<br />
	<form name="form2" method="post" action="user_setting.asp?action=unblogpassword" />
...
<div id="list">
    ...
    <ul> 
      ...
      <li class="t2"><input onFocus="this.select(); " name=question  type="text" size="30" maxlength="20" value="<%=oblog.filt_html(rs(0))%>"><font color="#FF0000"> *</font></li>
    </ul>
	 <ul> 
